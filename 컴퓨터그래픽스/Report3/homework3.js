...
window.onload = function init()
{
    ...
    document.getElementById("Image1").onclick = function() {
        configureTexture(document.getElementById("Image1"));
    };
    document.getElementById("Image2").onclick = function() {
        configureTexture(document.getElementById("Image2"));
    };
    document.getElementById("Image3").onclick = function() {
        configureTexture(document.getElementById("Image3"));
    };
    document.getElementById("Image4").onclick = function() {
        configureTexture(document.getElementById("Image4"));
    };
    document.getElementById("Image5").onclick = function() {
        configureTexture(document.getElementById("Image5"));
    };
